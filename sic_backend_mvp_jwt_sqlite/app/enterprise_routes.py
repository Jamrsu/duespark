...
from app.enterprise_models import Organization, Team, AuditEventType
from app.ai_intelligence_service import (
    get_payment_predictor, get_debt_collection_ai, get_business_intelligence_ai,
    PaymentPredictor, DebtCollectionAI, BusinessIntelligenceAI
)
from app.enterprise_security_service import get_enterprise_security_service, EnterpriseSecurityService
from app.advanced_analytics_service import get_advanced_analytics_service, AdvancedAnalyticsService, ReportDefinition
from app.infrastructure_service import get_infrastructure_service, BackgroundJob
...
async def get_business_insights(
    ...
    try:
        ...
        if category:
            insights = [insight for insight in insights if insight.insight_type == category]
...
async def get_real_time_dashboard(
    ...
    try:
        ...
        dashboard_data = analytics.get_real_time_dashboard(current_user, organization_id)
